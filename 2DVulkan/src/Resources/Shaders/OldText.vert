...
struct resultStruct
{
	...
	uvec2 InstartingGlyphHeaderLocation;		// x, y location of first header in fontDataSampler
};
...
void main() {
    ...
    vResult = resultStruct(vec4(inColor, 1.0), inTexCoord, PushConstants.glyphStartingLocation);
}